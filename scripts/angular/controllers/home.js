...
resumeApp.controller('mainController',
    ['$scope', '$localStorage', '$sessionStorage', 'prompts', 'basics', 'summary', 'jobs', 'projects', 'qualifications', 'skills',
    function($scope, $localStorage, $sessionStorage, prompts, basics, summary, jobs, projects, qualifications, skills){
    ...
    if(!prompts.answeredLocal){
        if ($storage.localBasics || $storage.localSummary || $storage.localJobs || $storage.localProjects || $storage.localQualifications || $storage.localSkills) {
